...
3. Read applicable DCs and `AGENTS.md`.
4. Inspect linked code and search for additional dependencies or consumers.
5. Confirm the intended outcome, invariants, and non-goals.
...
2. Follow its links through documents, code, configuration,
   data, APIs, and other artifacts.
...
6. Run the strongest practical verification loops (`npm run typecheck` + standalone runner).
...
|---|---|---|
| Initiative | `docs/IV-NNNN-<slug>.md` | `docs/IV-0001-remote-child-window.md` |
